...
message = client.messages.create(body="Hey Riyan! Batman here",to="+919163149163",from_="+19124175695")   #text message
...
#message2 is MMS
call = client.calls.create(to="+919163149163",from_="+19124175695",url="https://sumankanrar25.000webhostapp.com/upload/voice.mp3")
