...
"background-color: rgb(255, 170, 127);")
        ...
        self.table_contacts.setColumnCount(0)
...
"background-color: rgb(255, 170, 127);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btn_send_vmsg.setText(_translate("Dialog", "Send Voice Message"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_voicemsg), _translate("Dialog", "          Voice Message         "))
