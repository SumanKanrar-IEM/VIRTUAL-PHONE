...
class Ui_weather_screen(object):
    def setupUi(self, weather_screen):
        ...
        weather_screen.setStyleSheet("border-image: url(background2.png);")
        ...
        self.widget = QtWidgets.QWidget(weather_screen)
        self.widget.setGeometry(QtCore.QRect(30, 50, 651, 401))
        self.widget.setObjectName("widget")
        self.gridLayout = QtWidgets.QGridLayout(self.widget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.label_location = QtWidgets.QLabel(self.widget)
        ...
        self.value_location = QtWidgets.QLabel(self.widget)
        ...
        self.vaue_temperature = QtWidgets.QLabel(self.widget)
        ...
        self.label_skycondition = QtWidgets.QLabel(self.widget)
        ...
        self.value_skycondition = QtWidgets.QLabel(self.widget)
        ...
        self.label_humidity = QtWidgets.QLabel(self.widget)
        ...
        self.value_humidity = QtWidgets.QLabel(self.widget)
        ...
        self.value_windspeed = QtWidgets.QLabel(self.widget)
        ...
        self.value_windspeed_2 = QtWidgets.QLabel(self.widget)
